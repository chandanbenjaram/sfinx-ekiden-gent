...
/**
 * An activity to show the contact persons in a {@link ListView} or
 * {@link GridView}, depending whether the device is a phone or a tablet. This
 ...
 */
public class ContactPersonsActivity extends BaseMultiPaneActivity implements
		View.OnClickListener, FragmentManager.OnBackStackChangedListener {

	protected static final String TAG = "ContactPersonsActivity";

	private static final String CONTACT = "contact_persons";
	...
	public void updateBreadCrumb() {
		/*
		 * if (UIUtils.isHoneycombTablet(this)) { final String title =
		 * getString(R.string.title_sessions); final String detailTitle =
		 * getString(R.string.title_session_detail);
		 * 
		 * if (mFragmentManager.getBackStackEntryCount() >= 1) {
		 * mFragmentBreadCrumbs.setParentTitle(title, title, this);
		 * mFragmentBreadCrumbs.setTitle(detailTitle, detailTitle); } else {
