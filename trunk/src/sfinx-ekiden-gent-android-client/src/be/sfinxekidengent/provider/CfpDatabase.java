...
import be.sfinxekidengent.provider.CfpContract.BlocksColumns;
import be.sfinxekidengent.provider.CfpContract.NewsColumns;
import be.sfinxekidengent.provider.CfpContract.ParleysPresentationColumns;
import be.sfinxekidengent.provider.CfpContract.ParleysPresentations;
import be.sfinxekidengent.provider.CfpContract.Rooms;
import be.sfinxekidengent.provider.CfpContract.RoomsColumns;
import be.sfinxekidengent.provider.CfpContract.SessionTypes;
import be.sfinxekidengent.provider.CfpContract.SessionTypesColumns;
import be.sfinxekidengent.provider.CfpContract.Sessions;
import be.sfinxekidengent.provider.CfpContract.SessionsColumns;
import be.sfinxekidengent.provider.CfpContract.Speakers;
import be.sfinxekidengent.provider.CfpContract.SpeakersColumns;
import be.sfinxekidengent.provider.CfpContract.SyncColumns;
import be.sfinxekidengent.provider.CfpContract.Tags;
import be.sfinxekidengent.provider.CfpContract.TagsColumns;
import be.sfinxekidengent.provider.CfpContract.Tracks;
import be.sfinxekidengent.provider.CfpContract.TracksColumns;
import be.sfinxekidengent.provider.CfpContract.TweetsColumns;
...
public class CfpDatabase extends SQLiteOpenHelper {
	...
	private static final int VER_ADD_SYNC_COLUMNS_TO_BLOCKS = 23;
