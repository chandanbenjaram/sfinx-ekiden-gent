...
import be.sfinxekidengent.provider.CfpContract.SearchSuggest;
...
import be.sfinxekidengent.provider.CfpContract.Tweets;
import be.sfinxekidengent.provider.CfpDatabase.ParleysPresentationsTags;
import be.sfinxekidengent.provider.CfpDatabase.SessionsSearchColumns;
import be.sfinxekidengent.provider.CfpDatabase.SessionsSpeakers;
import be.sfinxekidengent.provider.CfpDatabase.SessionsTags;
import be.sfinxekidengent.provider.CfpDatabase.SpeakersSearchColumns;
import be.sfinxekidengent.provider.CfpDatabase.Tables;
import be.sfinxekidengent.service.CfpSyncService;
import be.sfinxekidengent.util.SelectionBuilder;
